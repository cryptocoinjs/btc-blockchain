...
var BufferArray = require('./BufferArray');
 ...
 */
var Storage = module.exports = function Storage(uri, callback) {
...
Storage.prototype.create = function(hash, data, callback) {
  ...
  if (typeof data.children !== 'undefined') {
    ...
    if (data.children instanceof Array) {
      ...
      callback(new Error('Can\'t process children argument of '+children));
      batch.clear();
    }
  }
